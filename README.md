...
14 tests couvrent le calcul de distance et le calcul du coût réel, notamment :
...
- Tracer l'itinéraire réel sur la carte (OSRM le fournit déjà via son service `route`, non utilisé ici — seul le service `table`, plus économe en requêtes, est utilisé).
